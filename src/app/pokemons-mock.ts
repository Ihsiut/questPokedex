...
export const POKEMONS: Pokemon[] = [
  {name : 'Bulbizarre',
  imageUrl: 'https://www.pokebip.com/pokedex/images/sugimori/1.png',
  ...
  {name : 'Salamèche',
  imageUrl: 'https://www.pokebip.com/pokedex/images/sugimori/4.png',
  // tslint:disable-next-line: max-line-length
  ...
  {name : 'Carapuce',
  imageUrl: 'https://www.pokebip.com/pokedex/images/sugimori/7.png',
  // tslint:disable-next-line: max-line-length
  ...
  {name : 'Pikachu',
  imageUrl: 'https://www.pokebip.com/pokedex/images/sugimori/25.png',
  // tslint:disable-next-line: max-line-length
